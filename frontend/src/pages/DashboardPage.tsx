...
export function DashboardPage() {
  ...
  return (
    <div className="space-y-5">
      <StatGrid>
        <StatCard title="Sales today" value={formatCurrency(kpis.salesToday)} icon={<DollarSign className="h-5 w-5 text-white" />} color="from-emerald-500 to-teal-600" to="/sales" />
        <StatCard title="Monthly Sales" value={formatCurrency(kpis.monthlyRevenue)} icon={<TrendingUp className="h-5 w-5 text-white" />} color="from-primary-500 to-primary-700" to="/finance" />
        <StatCard title="Production orders" value={kpis.productionOrders} icon={<Factory className="h-5 w-5 text-white" />} color="from-primary-600 to-primary-800" to="/production" />
        <StatCard title="Inventory value" value={formatCurrency(kpis.inventoryValue)} icon={<Package className="h-5 w-5 text-white" />} color="from-orange-500 to-amber-600" to="/inventory" />
        <StatCard title="Low stock" value={kpis.rawMaterialsLow} icon={<AlertTriangle className="h-5 w-5 text-white" />} color="from-red-500 to-rose-600" to="/inventory" />
      </StatGrid>
