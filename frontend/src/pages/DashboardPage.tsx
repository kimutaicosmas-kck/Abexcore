  ...
  return (
    <div className="space-y-5">
      <StatGrid>
        ...
        <StatCard title="Monthly Sales" value={formatCurrency(kpis.monthlyRevenue)} icon={<TrendingUp className="h-5 w-5 text-white" />} color="from-primary-500 to-primary-700" />
