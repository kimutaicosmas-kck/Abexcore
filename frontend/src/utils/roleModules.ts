...
export const MODULE_LABELS: Record<string, string> = {
  ...
  reports: 'Reports',
  sales_performance: 'Sales performance & targets',
...
const ROLE_MODULE_ACCESS: Record<string, readonly string[]> = {
  ...
  'Sales Manager': ['dashboard', 'customers', 'sales', 'pos', 'delivery', 'reports', 'sales_performance'],
  ...
  'Finance Manager': ['dashboard', 'finance', 'reports', 'sales', 'approvals', 'sales_performance'],
  ...
  'Sales Officer': ['dashboard', 'customers', 'sales', 'pos', 'products'],
  'Sales Executive': ['dashboard', 'customers', 'sales', 'pos', 'products'],
  'Sales Representative': ['dashboard', 'customers', 'sales', 'pos', 'products'], // legacy
