...
echo ""
echo " Next: enable daily backups:"
echo "   chmod +x scripts/install-backup-cron.sh scripts/server-backup.sh"
echo "   ./scripts/install-backup-cron.sh && ./scripts/server-backup.sh"
echo "=============================================="
